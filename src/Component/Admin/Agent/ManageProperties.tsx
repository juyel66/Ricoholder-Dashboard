...
const demoProperties = [
    { id: 1, name: 'Luxury Waterfront Villa', location: 'Miami Beach, FL', status: 'Published', imageUrl: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c', assigned: false },
    { id: 2, name: 'Modern Downtown Penthouse', location: 'New York, NY', status: 'Published', imageUrl: 'https://images.unsplash.com/photo-1505691938895-1758d7feb511', assigned: true },
    { id: 3, name: 'Elegant Historic Mansion', location: 'Boston, MA', status: 'Pending Review', imageUrl: 'https://images.unsplash.com/photo-1600607688969-a5bfcd646154', assigned: false },
    { id: 4, name: 'Contemporary Beach House', location: 'Malibu, CA', status: 'Draft', imageUrl: 'https://images.unsplash.com/photo-1600607689390-1d5c2a3f0c4f', assigned: false },
    { id: 5, name: 'Stylish City Apartment', location: 'Seattle, WA', status: 'Published', imageUrl: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2', assigned: true },
];
        ...
        <div className="bg-gray-50 min-h-screen p-6 md:p-10 flex flex-col items-center">
            <div className="w-full bg-white rounded-xl shadow-2xl p-6 md:p-8">
                ...
                <header className="mb-8 border-b border-gray-100 pb-4">
                    ...
                    <p className="text-xl font-medium text-blue-600 mt-1">{agentName}</p>
                </header>
